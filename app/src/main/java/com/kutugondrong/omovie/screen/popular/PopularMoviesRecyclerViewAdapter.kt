...
import com.kutugondrong.omovie.databinding.FragmentPopularMoviesBinding
...
class PopularMoviesRecyclerViewAdapter(
    ...
    PagingDataAdapter<Movie, PopularMoviesRecyclerViewAdapter.ViewHolder>(COMPARATOR) {

    inner class ViewHolder(private val binding: FragmentPopularMoviesBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val moviesBinding = FragmentPopularMoviesBinding.inflate(
